...
using System;
using Huobi.SDK.Core.Spot.RESTful.Response.Order;
using Huobi.SDK.Core.Spot.RESTful.Request.Order;
...
namespace Huobi.SDK.Core.Spot.RESTful
{
    ...
    public class OrderClient
    {
        ...
        public OrderClient(string accessKey, string secretKey, string host = Host.SPOT)
        {
