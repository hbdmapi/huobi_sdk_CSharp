...
using Huobi.SDK.Core.Spot.RESTful.Response.SubUser;
using Huobi.SDK.Core.Spot.RESTful.Request.SubUser;
...
namespace Huobi.SDK.Core.Spot.RESTful
{
    ...
    public class SubUserClient
    {
        ...
        public SubUserClient(string accessKey, string secretKey, string host = Host.SPOT)
        {
