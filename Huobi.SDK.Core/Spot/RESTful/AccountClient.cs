...
namespace Huobi.SDK.Core.Spot.RESTful
{
    ...
    public class AccountClient
    {
        ...
        public AccountClient(string accessKey, string secretKey, string host = Host.SPOT)
        {
        ...
        {
            GetRequest getq = new GetRequest();
            getq.AddParam("accountType", accountType);
            getq.AddParam("valuationCurrency", valuationCurrency);

            string url = _urlBuilder.Build(GET_METHOD, "/v2/account/valuation", getq);
        ...
        public async Task<GetAccountAssetValuationResponse> GetAccountAssetValuationAsync(string accountType, string valuationCurrency = "BTC", long? subUid = null)
        {
